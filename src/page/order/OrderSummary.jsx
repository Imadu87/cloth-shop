      ...
      <div className="max-w-[1000px] mx-auto px-4 space-y-6">
        ...
        <div className="flex flex-col items-center text-center space-y-2">
          ...
          <div className="bg-white rounded-xl shadow p-6 text-gray-700 space-y-2">
            <p className="font-medium text-lg">Your order is confirmed</p>
            <p>We'll contact you soon on {order.customer.phone}</p>
        ...
        <div className="bg-white rounded-xl shadow p-6 space-y-6">
          <h3 className="text-lg font-semibold">Orders Detail</h3>
          ...
          <div className="mt-6">
            ...
            <span className="font-medium">Total Price: Rs {order.total}</span>
          </div>

          {/* Footer */}
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 mt-6">
            <p className="text-gray-700">Need help? Contact Us</p>
